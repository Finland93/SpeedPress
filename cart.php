...
<main class="container mt-5">
    <div class="row">
        <div class="col-md-8">
            <h1 class="page-title mb-4"><?php esc_html_e('Your Cart', 'woocommerce'); ?></h1>
            <?php
            wc_print_notices();
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="6" class="actions">
                                ...
                                <button type="submit" class="btn btn-primary" name="update_cart" value="<?php esc_attr_e('Update cart', 'woocommerce'); ?>"><?php esc_attr_e('Update cart', 'woocommerce'); ?></button>
